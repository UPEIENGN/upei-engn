...
import { Society } from '@/types/index.d.ts';
        ...
        <div class="mx-auto max-w-7xl overflow-hidden px-6 py-10 sm:py-12 lg:px-8">
            <nav class="-mb-6 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm/6" aria-label="Footer">
                <a
                    ...
                    :key="item.name"
                    :href="item.href"
                    class="cursor-pointer text-gray-600 hover:text-neutral-900 dark:text-gray-400 dark:hover:text-white"
                    >{{ item.name }}</a
                >
            </nav>
            <div class="mt-16 flex justify-center gap-x-10">
                <template v-for="item in navigation.social">
                    <a
                        v-if="item.href"
                        :key="item.name"
                        :href="item.href"
